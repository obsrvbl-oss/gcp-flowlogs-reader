...
* `collect_multiple_projects` - defaults to True, collecting projects if available via the [`google.cloud.resource_manager`](https://cloud.google.com/resource-manager/docs/)
